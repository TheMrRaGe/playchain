 ...
 */
static const char* BITCOIN_PID_FILENAME = "playchaind.pid";
...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-trackgame=<game>", "Enable tracking of the listed game for the Playchain game interface", ArgsManager::ALLOW_ANY, OptionsCategory::ZMQ);
#else
