...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitcoin Core, Namecoin and Playchain developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitcoin Core, Namecoin and Playchain"
...
#define PACKAGE_BUGREPORT "https://github.com/playchain/playchain/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Playchain"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Playchain 1.8.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "playchain"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://playchain.io/"

/* Define to the version of this package. */
#define PACKAGE_VERSION "1.8.99"
