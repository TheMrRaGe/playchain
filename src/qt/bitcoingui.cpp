...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Playchain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments and name transfers (generates QR codes and playchain: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a playchain: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Playchain command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Playchain network.", "", count);
    } else {
        //: A substring of the tooltip.
