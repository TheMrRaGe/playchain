...
{
    switch (unit) {
    case Unit::BTC: return QString("BITS");
    case Unit::mBTC: return QString("mBITS");
    case Unit::uBTC: return QString::fromUtf8("µBITS");
...
{
    switch (unit) {
    case Unit::BTC: return QString("PlayChain");
    case Unit::mBTC: return QString("Milli-BITS (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-BITS (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
