...
BOOST_AUTO_TEST_CASE(descriptor_test)
{
    ...
    CheckUnparsable("pkh(deadbeef/1/2'/3/4']LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF)", "pkh(deadbeef/1/2'/3/4']03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", "pkh(): Key origin start '[ character expected but not found, got 'd' instead"); // Missing start bracket in key origin
    CheckUnparsable("pkh([deadbeef]/1/2'/3/4']LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF)", "pkh([deadbeef]/1/2'/3/4']03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", "pkh(): Multiple ']' characters found for a single pubkey"); // Multiple end brackets in key origin
    ...
    /* Playchain has larger max script elements than upstream, so the following
    ...
    Check(
        "rawtr(LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF)",
    ...
    // Invalid checksum
    CheckUnparsable("wsh(and_v(vc:andor(pk(LMqc9ZuSKbD6i2tnoJWcP9rKCgxjUsKQ8V4ubFfCZ48c2bLqFTqQ),pk_k(LFJYLYT55F5tdXQEa1DsaRZd4VcQbVC35yFuLs2QBhmwUQHgtX4H),and_v(v:older(1),pk_k(LMxHtYeKsXFYyXTh1LabVnoK8mvBjU7EfuL8m2T7Dgp4xgVc6qFa))),after(10)))#abcdef12", "wsh(and_v(vc:andor(pk(03cdabb7f2dce7bfbd8a0b9570c6fd1e712e5d64045e9d6b517b3d5072251dc204),pk_k(032707170c71d8f75e4ca4e3fce870b9409dcaf12b051d3bcadff74747fa7619c0),and_v(v:older(1),pk_k(02aa27e5eb2c185e87cd1dbc3e0efc9cb1175235e0259df1713424941c3cb40402))),after(10)))#abcdef12", "Provided checksum 'abcdef12' does not match computed checksum 'tyzp6a7p'");
    // Only p2wsh context is valid
    CheckUnparsable("sh(and_v(vc:andor(pk(LMqc9ZuSKbD6i2tnoJWcP9rKCgxjUsKQ8V4ubFfCZ48c2bLqFTqQ),pk_k(LFJYLYT55F5tdXQEa1DsaRZd4VcQbVC35yFuLs2QBhmwUQHgtX4H),and_v(v:older(1),pk_k(LMxHtYeKsXFYyXTh1LabVnoK8mvBjU7EfuL8m2T7Dgp4xgVc6qFa))),after(10)))", "sh(and_v(vc:andor(pk(03cdabb7f2dce7bfbd8a0b9570c6fd1e712e5d64045e9d6b517b3d5072251dc204),pk_k(032707170c71d8f75e4ca4e3fce870b9409dcaf12b051d3bcadff74747fa7619c0),and_v(v:older(1),pk_k(02aa27e5eb2c185e87cd1dbc3e0efc9cb1175235e0259df1713424941c3cb40402))),after(10)))", "Miniscript expressions can only be used in wsh");
    CheckUnparsable("tr(and_v(vc:andor(pk(LMqc9ZuSKbD6i2tnoJWcP9rKCgxjUsKQ8V4ubFfCZ48c2bLqFTqQ),pk_k(LFJYLYT55F5tdXQEa1DsaRZd4VcQbVC35yFuLs2QBhmwUQHgtX4H),and_v(v:older(1),pk_k(LMxHtYeKsXFYyXTh1LabVnoK8mvBjU7EfuL8m2T7Dgp4xgVc6qFa))),after(10)))", "tr(and_v(vc:andor(pk(03cdabb7f2dce7bfbd8a0b9570c6fd1e712e5d64045e9d6b517b3d5072251dc204),pk_k(032707170c71d8f75e4ca4e3fce870b9409dcaf12b051d3bcadff74747fa7619c0),and_v(v:older(1),pk_k(02aa27e5eb2c185e87cd1dbc3e0efc9cb1175235e0259df1713424941c3cb40402))),after(10)))", "tr(): key 'and_v(vc:andor(pk(03cdabb7f2dce7bfbd8a0b9570c6fd1e712e5d64045e9d6b517b3d5072251dc204),pk_k(032707170c71d8f75e4ca4e3fce870b9409dcaf12b051d3bcadff74747fa7619c0),and_v(v:older(1),pk_k(02aa27e5eb2c185e87cd1dbc3e0efc9cb1175235e0259df1713424941c3cb40402))),after(10))' is not valid");
    CheckUnparsable("raw(and_v(vc:andor(pk(LMqc9ZuSKbD6i2tnoJWcP9rKCgxjUsKQ8V4ubFfCZ48c2bLqFTqQ),pk_k(LFJYLYT55F5tdXQEa1DsaRZd4VcQbVC35yFuLs2QBhmwUQHgtX4H),and_v(v:older(1),pk_k(LMxHtYeKsXFYyXTh1LabVnoK8mvBjU7EfuL8m2T7Dgp4xgVc6qFa))),after(10)))", "sh(and_v(vc:andor(pk(03cdabb7f2dce7bfbd8a0b9570c6fd1e712e5d64045e9d6b517b3d5072251dc204),pk_k(032707170c71d8f75e4ca4e3fce870b9409dcaf12b051d3bcadff74747fa7619c0),and_v(v:older(1),pk_k(02aa27e5eb2c185e87cd1dbc3e0efc9cb1175235e0259df1713424941c3cb40402))),after(10)))", "Miniscript expressions can only be used in wsh");
    ...
    // Insane at top level
    CheckUnparsable("wsh(and_b(vc:andor(pk(LMqc9ZuSKbD6i2tnoJWcP9rKCgxjUsKQ8V4ubFfCZ48c2bLqFTqQ),pk_k(LFJYLYT55F5tdXQEa1DsaRZd4VcQbVC35yFuLs2QBhmwUQHgtX4H),and_v(v:older(1),pk_k(LMxHtYeKsXFYyXTh1LabVnoK8mvBjU7EfuL8m2T7Dgp4xgVc6qFa))),after(10)))", "wsh(and_b(vc:andor(pk(03cdabb7f2dce7bfbd8a0b9570c6fd1e712e5d64045e9d6b517b3d5072251dc204),pk_k(032707170c71d8f75e4ca4e3fce870b9409dcaf12b051d3bcadff74747fa7619c0),and_v(v:older(1),pk_k(02aa27e5eb2c185e87cd1dbc3e0efc9cb1175235e0259df1713424941c3cb40402))),after(10)))", "and_b(vc:andor(pk(03cdabb7f2dce7bfbd8a0b9570c6fd1e712e5d64045e9d6b517b3d5072251dc204),pk_k(032707170c71d8f75e4ca4e3fce870b9409dcaf12b051d3bcadff74747fa7619c0),and_v(v:older(1),pk_k(02aa27e5eb2c185e87cd1dbc3e0efc9cb1175235e0259df1713424941c3cb40402))),after(10)) is invalid");
    // Invalid sub
    CheckUnparsable("wsh(and_v(vc:andor(v:pk_k(LMqc9ZuSKbD6i2tnoJWcP9rKCgxjUsKQ8V4ubFfCZ48c2bLqFTqQ),pk_k(LFJYLYT55F5tdXQEa1DsaRZd4VcQbVC35yFuLs2QBhmwUQHgtX4H),and_v(v:older(1),pk_k(LMxHtYeKsXFYyXTh1LabVnoK8mvBjU7EfuL8m2T7Dgp4xgVc6qFa))),after(10)))", "wsh(and_v(vc:andor(v:pk_k(03cdabb7f2dce7bfbd8a0b9570c6fd1e712e5d64045e9d6b517b3d5072251dc204),pk_k(032707170c71d8f75e4ca4e3fce870b9409dcaf12b051d3bcadff74747fa7619c0),and_v(v:older(1),pk_k(02aa27e5eb2c185e87cd1dbc3e0efc9cb1175235e0259df1713424941c3cb40402))),after(10)))", "v:pk_k(03cdabb7f2dce7bfbd8a0b9570c6fd1e712e5d64045e9d6b517b3d5072251dc204) is invalid");
    // Insane subs
    CheckUnparsable("wsh(or_i(older(1),pk(LMqc9ZuSKbD6i2tnoJWcP9rKCgxjUsKQ8V4ubFfCZ48c2bLqFTqQ)))", "wsh(or_i(older(1),pk(03cdabb7f2dce7bfbd8a0b9570c6fd1e712e5d64045e9d6b517b3d5072251dc204)))", "or_i(older(1),pk(03cdabb7f2dce7bfbd8a0b9570c6fd1e712e5d64045e9d6b517b3d5072251dc204)) is not sane: witnesses without signature exist");
