...
from test_framework.playchain_zmq import (
  PlaychainZmqTest,
  ZmqSubscriber,
)
...
class GameBlocksTest (PlaychainZmqTest):
  ...
  def _test_burn (self):
    """
    Tests BITS burns in moves.
    """

    self.log.info ("Sending move with BITS burns...")

    # We send a tx that includes moves for two games as well as some BITS burns
    ...
    # name_update options argument.  playchain_gamepending.py verifies that the
