#!/usr/bin/env python3
# Copyright (c) 2019-2022 The Playchain developers
...
def assertMove (obj, txid, name, move):
  ...
  # exact form for this test (this is verified in playchain_gameblocks.py in
  # more detail).
  for key in ["inputs", "out", "btxid"]:
    assert key in obj


class GamePendingTest (PlaychainZmqTest):
  ...
  def _test_sendAndBurn (self):
    self.log.info ("Sending and burning BITS...")
