...
#   Playchain Stats - extract Playchain blockchain statistics
#   Copyright (C) 2020  The Playchain developers
#
...
# For this script to work, the valueencoding of Playchain Core should
# be set to "hex".
...
parser.add_argument ("--rpc_url", required=True,
                     help="JSON-RPC URL for Playchain Core")
...
log.info ("Connected to Playchain Core version %d" % data["version"])
